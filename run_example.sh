...
CUDA_VISIBLE_DEVICES=1 python -m tevatron.driver.train \
  ...
  --save_steps 2000 \
  --train_dir ./data/data_incre_aug/session_2/train_dir_top200_sample100 \
  --data_cache_dir ./data/data_incre_aug/session_2/lotte-train2_t200_s100-cache \
  --fp16 \
  ...
  --query_data ./data/data_incre_aug/train_dir/train.jsonl \
  --doc_data ./data/data_incre_aug/session_all2/corpus_dir/all_corpus.jsonl \
  --mem_size 30 \
  --mem_batch_size 2 \
  --cl_method 'our' \
